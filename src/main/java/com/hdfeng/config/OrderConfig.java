...
@Configuration
@MapperScan(basePackages = "com.hdfeng.dao.order", sqlSessionTemplateRef = "orderSqlSessionTemplate")
public class OrderConfig {
	...
	public SqlSessionTemplate orderSqlSessionTemplate(
			@Qualifier("orderSqlSessionFactory") SqlSessionFactory orderSqlSessionFactory) throws Exception {
